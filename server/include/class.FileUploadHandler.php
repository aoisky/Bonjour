<?php
/**
 * class.FileUploadHandler.php
 *
 * The handler class for file uploading operation
...
class FileUploadHandler {
	...
	protected $error_messages = array(
		...
		'max_file_size' => 'File size is bigger than the maximum allowed',
		'min_file_size' => 'File size is smaller than minimum allowed',
