...
/**
 * Mail.php
 * A high-level wrapper of PHP mail() function
 * If emails cannot be sent one must check if the system command sendmail() is correctly set
 * 
 * Purdue CS307 Project Ugl
 *
 * @author	Xiangyu Bu
 * @version	0.2
 *
