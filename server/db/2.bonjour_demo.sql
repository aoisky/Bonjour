...
CREATE TABLE `users` (
  ...
  `user_securityQuestion` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_securityAnswerHash` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
--
-- Dumping events for database 'bonjour_demo'
--

--
-- Dumping routines for database 'bonjour_demo'
--
...
-- Dump completed on 2014-03-08 14:27:35
