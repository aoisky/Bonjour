CREATE DATABASE  IF NOT EXISTS `bonjour_demo` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `bonjour_demo`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: localhost    Database: bonjour_demo
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `user_hobby` text COLLATE utf8_unicode_ci,
...
-- Dump completed on 2014-02-13 20:53:42
